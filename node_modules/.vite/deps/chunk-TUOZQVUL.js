...
var HLSController = class {
  ...
  _destroy() {
    ...
    (_d = (_c = this._context) == null ? void 0 : _c.logger) == null ? void 0 : _d.info("🏗️ Destroyed HLS instance");
  }
};
...
var HTMLMediaEvents = class {
  ...
  _onDevEvent(event2) {
    var _a, _b;
    (_a = this._context.logger) == null ? void 0 : _a.debugGroup(`📺 fired \`${event2.type}\``).labelledLog("Event", event2).labelledLog("Media Store", { ...this._context.$store }).dispatch();
...
//# sourceMappingURL=chunk-TUOZQVUL.js.map
